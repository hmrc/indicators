...
case class Release(name: String, version: String, creationDate: Option[LocalDateTime], productionDate: LocalDateTime, leadTime: Option[Long] = None, interval: Option[Long] = None)

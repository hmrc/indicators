...
//      ReleaseMetricCalculator.calculateLeadTimeMetric(releases, 1) shouldBe List(ReleaseLeadTimeResult(YearMonth.from(Feb_1st), Some(6)))
  ...
  "ReleaseMetricCalculator.calculateReleaseInterval" should {
    ...
    "calculate the median release interval for 7 months (3 months sliding window) when provided releases are not ordered" in new SetUp {
      ...
      val releases = List(
        Release("test-service", "7.0.0", None, Apr_1st),
        Release("test-service", "8.0.0", None, Apr_11th),
        Release("test-service", "1.0.0", None, Feb_4th),
        Release("test-service", "2.0.0", None, Feb_10th),
        Release("test-service", "3.0.0", None, Feb_16th),
        Release("test-service", "4.0.0", None, Feb_18th),
        Release("test-service", "5.0.0", None, Mar_1st),
        Release("test-service", "6.0.0", None, Mar_27th),
        Release("test-service", "9.0.0", None, May_11th),
        Release("test-service", "10.0.0", None, June_5th))
